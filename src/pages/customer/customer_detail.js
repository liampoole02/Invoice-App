            ...
            <div className="card">
                ...
                <div className="card-body">
                    ...
                    <div className="mb-3">
                        ...
                        <input type="text" className="form-control" placeholder="Contact Email" value={customer.contact_email} onChange={e => setCustomer({ ...customer, contact_email: e.target.value })} />
                    </div>
